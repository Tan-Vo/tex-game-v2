...
A high-performance C# / .NET game application and core game system built with clean architecture, smooth rendering, and optimized mechanics.
...
```bash
git clone https://github.com/Tan-Vo/tex-game-v2.git
cd tex-game-v2
